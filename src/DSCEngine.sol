...
function _burnDsc(uint256 amountDscToBurn, address onBehalfOf, address dscFrom) private {
    ...
    */
    ...
    {
        totalDscMinted = s_DSCMinted[user]; // gets dsc minted by user
        collateralValueInUsd = getAccountCollateralValue(user); // gets collateral value in usd
    }
